    ...
    <div 
      ...
      <div className='w-[100%] flex overflow-y-hidden mb-5 p-5'>
        {info.details.seasons.length > 0 ? info.details.seasons.map((s,i) => (
          <div className='w-[10vh] mr-[10%]'>
            <img 
                  className='h-[30vh] min-w-[10vw]  object-cover rounded shadow-zinc-400' 
                  src={`https://image.tmdb.org/t/p/original/${s.poster_path}`} 
                  alt="" 
                />
                <h1 className='text-2xl w-[10vw] text-center font-semibold text-zinc-300 mt-2'>
                  {s.name}
                </h1>
          </div>
        )) : (
      ...
      {/* part 5 recommendation and similar things */}
      <hr className='mt-10 mb-5 bg-zinc-400 border-none h-[2px]'/>
